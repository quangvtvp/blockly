...
function updatePreview() {
  ...
  if (oldDir != newDir) {
    ...
    var rtl = newDir == 'rtl';
    previewWorkspace = Blockly.inject('preview',{rtl: rtl, media: 'media/', sounds: true, scrollbars: true});
    oldDir = newDir;
  }
...
function init() {
  ...
  mainWorkspace = Blockly.inject('blockly',{toolbox: toolbox, media: 'media/', sounds: true});
